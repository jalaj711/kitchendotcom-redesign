      ...
      <div className={styles.card}>
        ...
        <div className={styles.div1}>
          <div className={styles.v1}>
            ...
            <h2 className={styles.ess}>Luxe</h2>
          ...
          <div className={styles.para}>
            ...
            <p className={styles.p1}>
              Choose this if you want to go all out to ensure your dream luxury
              kitchen gives you an exquisite culinary expierience that fits your
              lifestyle.
            </p>
          </div>
        </div>

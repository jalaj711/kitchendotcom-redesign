      ...
      <div className={styles.card}>
        ...
        <div className={styles.div1}>
          <div className={styles.v1}>
            ...
            <h2 className={styles.ess}>Build your own package</h2>
          ...
          <div className={styles.para}>
            ...
            <p className={styles.p1}>
              If you’re sure about the other options, you can always customise
              your package that works well for your kitchen needs.
            </p>
          </div>
        </div>
